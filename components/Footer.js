...
export default class Footer extends Component {
    constructor(props) {
        ...
        this.state = {
            mainData: [
                ...
                {
                    title: '产品与服务',
                    secondMain: [{name: '蜂巢', url: 'BeeHive'}, {name: '蜂眼', url: '/BeeEye'}, {
                        name: '网络安全服务',
                        url: '/SecurityService'
                    }]
                },
                // {
                //     title: '伙伴',
                //     secondMain: ['合作伙伴计划','成为合伙人','成为合作伙伴']
                // },
                {
                    title: '解决方案',
                    secondMain: [{name: '网络应用方案', url: '/Solution'}]
                },
                {
                    title: '关于公司',
                    secondMain: [{name: '招聘', url: 'Recruit'}, {name: '新闻中心', url: '/PressCenter'}]
                },
                {
                    title: '联系方式',
                    secondMain: [{name: '电话：010-57235115', url: ''}, {
                        name: 'E-mail: info@zeronedata.cn',
                        url: ''
                    }, {name: '邮编：100020', url: ''}, {name: '地址: 北京市朝阳区安定门外大街1号信义大厦11层', url: ''}]
                }
            ]
        }
    ...
    renderMainCell() {
        ...
        data.map((val, index) => {
            arr.push(
                <li key={index}>
                    <div className={cx('footerMainCell')}>
                        <p>{val.title}</p>
                        <ul>
                            {
                                val.secondMain.map((val2, index2) => {
                                    return (
    ...
    jump(url) {
        ...
        //     // }
        // })
        if(url) Router.push({pathname: url})
    }
        ...
        return (
            <footer className={cx('footerContainer')}>
                <div className={cx('footerWrapper')}>
                    <div className={cx('footerTopWrapper')}>
                        ...
                        <div>
                            {/*<svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 2" viewBox="0 0 21.43 16.56">*/}
                            {/*<path fill= "#C8CACB"  d="M.18 15a.44.44 0 0 1-.16-.5.5.5 0 0 1 .46-.33 9.36 9.36 0 0 0 4.56-1.1 4.3 4.3 0 0 1-4-2.92.4.4 0 0 1 .14-.46.46.46 0 0 1 .5 0 3.12 3.12 0 0 0 1.75.4A6.8 6.8 0 0 1 .3 6.35a.4.4 0 0 1 .2-.46.46.46 0 0 1 .52 0 2.85 2.85 0 0 0 1.48.6A4.44 4.44 0 0 1 1.43.9l.23-.43.35.35c2.26 2.24 4.34 3.27 8.1 4v-.14A4.7 4.7 0 0 1 14.8 0a7.68 7.68 0 0 1 3 1 .1.1 0 0 0 .08 0c.7-.2 1.6-.56 2.62-1a.42.42 0 0 1 .43.07.37.37 0 0 1 .1.4 4.6 4.6 0 0 1-.9 1.48l.72-.24a.44.44 0 0 1 .44.1.4.4 0 0 1 .1.4 3.44 3.44 0 0 1-1.8 2.13v.12A11.87 11.87 0 0 1 8 16.55C4.4 16.56 1.48 16 .18 15z"/>*/}
                            {/*</svg>*/}
                            {/*<svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 2" viewBox="0 0 21.43 16.56">*/}
                            {/*<path fill="#C8CACB"  d="M.18 15a.44.44 0 0 1-.16-.5.5.5 0 0 1 .46-.33 9.36 9.36 0 0 0 4.56-1.1 4.3 4.3 0 0 1-4-2.92.4.4 0 0 1 .14-.46.46.46 0 0 1 .5 0 3.12 3.12 0 0 0 1.75.4A6.8 6.8 0 0 1 .3 6.35a.4.4 0 0 1 .2-.46.46.46 0 0 1 .52 0 2.85 2.85 0 0 0 1.48.6A4.44 4.44 0 0 1 1.43.9l.23-.43.35.35c2.26 2.24 4.34 3.27 8.1 4v-.14A4.7 4.7 0 0 1 14.8 0a7.68 7.68 0 0 1 3 1 .1.1 0 0 0 .08 0c.7-.2 1.6-.56 2.62-1a.42.42 0 0 1 .43.07.37.37 0 0 1 .1.4 4.6 4.6 0 0 1-.9 1.48l.72-.24a.44.44 0 0 1 .44.1.4.4 0 0 1 .1.4 3.44 3.44 0 0 1-1.8 2.13v.12A11.87 11.87 0 0 1 8 16.55C4.4 16.56 1.48 16 .18 15z"/>*/}
                            {/*</svg>*/}
                    ...
                    <div className={cx('footerMainWrapper')}>
                        <ul>
                            {this.renderMainCell()}
                        </ul>
                    </div>

                    <div className={cx('footerBottomWrapper')}>
                        <div className={cx('footerBottomLeft')}>
                            <span>Copyright © www.zeronedata.com. All Rights Reserved.</span>
                            <span>京ICP备17007998号</span>
                        </div>
                        <div className={cx('footerBottomRight')}>
                            <span>隐私政策</span>
                            <span>条款和条件</span>
                            <span>许可协议</span>
                            <span>网站地图</span>
